...
export default {
    ...
    methods:{
        ...
        data_check(){
            if(this.company != "请输入公司名称" && this.company != "" && this.company != null && this.type != "" && this.img_array != "" && this.img_array != null ){
        ...
        submit(){
            ...
            // formdata.append('clockshows', _self.message)
        ...
        getFieldType(){
            ...
            this.$http.get(url,config).then(function(res){
                if(res.data.msgCode == "40000"){
                    _self.fieldType = res.data.data.market_field_type
                }else{
                    _self.$toast.fail('系统错误！') 
                }
