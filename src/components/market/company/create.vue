...
<script>
import CustomerList from "../moa-components/common/customerList";
import RegAddress from "../moa-components/common/regAddress";
import ImportLevel from "../moa-components/common/importLevel";
import CompanySrc from "../moa-components/common/companySrc";
import TradingStatus from "../moa-components/common/tradingStatus";
import TaxType from "../moa-components/common/taxType";
export default {
  data() {
    return {
      belongClient: "",
