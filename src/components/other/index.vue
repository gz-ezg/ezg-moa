...
export default {
    ...
    methods:{
        ...
        //         _self.$bus.emit('open_workorder_list',_self.company)
        //     }else{
...
// console.log(_self.fieldType)
        ...
        getWxLocal(){
          ...
          let config = {
            params:{
              ...
              // url: "http%3A%2F%2Fqq364525897.w3.luyouxia.net%2F"
            }
          }
              ...
              wx.ready(function(){
                wx.getLocation({
                  ...
                  success: function(res){
                    ...
                    _self.WxLocal2String(latitude,longitude)
                  },
                  fail: function(err){
                    // alert(err)
                    console.log("fail_error",err)
                  }
                })
              })
            }else{
        ...
        WxLocal2String(x,y){
          let url = `api/system/wechat/address/location`
          let config = {
            params:{
              lat: x,
              lng: y
          ...
          this.$http.get(url,config).then(function(res){
            ...
            console.log(temp.result.address)
          })
        }

    },
    created(){
      // this.WxLocal2String(1,1)
        this.getFieldType()
        // this.getLocalIndex()
        let _self = this
    },
